...
const education = [
  {
    ...
    location: "Rwanda",
    description:
      "Pursuing advanced software development studies with focus on modern web technologies, database management, and software engineering principles.",
  ...
  return (
    <section id="education" className="section-padding relative">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-purple-400 font-mono text-sm mb-2">// education</p>
