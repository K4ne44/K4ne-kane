...
const contactInfo = [
  { icon: "fa-envelope", label: "Email", value: "muvunyihidjazi@gmail.com", href: "mailto:muvunyihidjazi@gmail.com" },
  { icon: "fa-phone", label: "Phone", value: "+250 *** *** ***", href: "tel:+250" },
  { icon: "fab fa-github", label: "GitHub", value: "github.com/k4ne", href: "https://github.com/k4ne" },
...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const mailtoLink = `mailto:muvunyihidjazi@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Name: ${formData.name}\nEmail: ${formData.email}\n\n${formData.message}`)}`;
  ...
  return (
    <section id="contact" className="section-padding relative">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-purple-400 font-mono text-sm mb-2">// contact</p>
